...
constexpr const char* DEFAULT_JSON = R"##(// This is a configuration file for the Sail RISC-V emulator.
//
// You can copy and then modify it to create a new configuration file,
// and then use the `--config` option to use it with the
// `sail_riscv_sim` emulator.  If any CMake  placeholders
...
constexpr const char* DEFAULT_JSON_RV32 = R"##(// This is a configuration file for the Sail RISC-V emulator.
//
// You can copy and then modify it to create a new configuration file,
// and then use the `--config` option to use it with the
// `sail_riscv_sim` emulator.  If any CMake  placeholders
