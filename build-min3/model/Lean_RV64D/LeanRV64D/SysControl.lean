...
def is_CSR_accessible (arg0 : (BitVec 12)) (arg1 : Privilege) (arg2 : CSRAccessType) : SailM Bool := do
  ...
  | (v__3852, g__94, g__95) =>
    (do
      if (((Sail.BitVec.extractLsb v__3852 11 4) == (0x3A#8 : (BitVec 8))) : Bool)
      then
        (let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__3852 3 0)
        (pure ((sys_pmp_count >b (4 *i (BitVec.toNatInt idx))) && (((BitVec.access idx 0) == 0#1) || (xlen == 32)))))
      else
        (do
          if (((Sail.BitVec.extractLsb v__3852 11 4) == (0x3B#8 : (BitVec 8))) : Bool)
          then
            (let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__3852 3 0)
            (pure (sys_pmp_count >b (BitVec.toNatInt (0b00#2 +++ idx)))))
          else
            (do
              if (((Sail.BitVec.extractLsb v__3852 11 4) == (0x3C#8 : (BitVec 8))) : Bool)
              then
                (let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__3852 3 0)
                (pure (sys_pmp_count >b (BitVec.toNatInt (0b01#2 +++ idx)))))
              else
                (do
                  if (((Sail.BitVec.extractLsb v__3852 11 4) == (0x3D#8 : (BitVec 8))) : Bool)
                  then
                    (let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__3852 3 0)
                    (pure (sys_pmp_count >b (BitVec.toNatInt (0b10#2 +++ idx)))))
                  else
                    (do
                      if (((Sail.BitVec.extractLsb v__3852 11 4) == (0x3E#8 : (BitVec 8))) : Bool)
                      then
                        (let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__3852 3 0)
                        (pure (sys_pmp_count >b (BitVec.toNatInt (0b11#2 +++ idx)))))
                      else
                        (do
                          match (v__3852, g__94, g__95) with
                          | (0x001, g__96, g__97) =>
                          ...
                          | (0x015, g__94, g__95) =>
                            (pure ((← (currentlyEnabled Ext_Zkr)) && ((bne g__95 CSRRead) && (← do
                                    ...
                                    | .VirtualSupervisor => (pure false)
                                    | .VirtualUser => (pure false)))))
                          | (v__3852, g__165, g__166) =>
                            (do
                              if ((((Sail.BitVec.extractLsb v__3852 11 5) == (0b0011001#7 : (BitVec 7))) && (let index : (BitVec 5) :=
                                     (Sail.BitVec.extractLsb v__3852 4 0)
                                   ((BitVec.toNatInt index) ≥b 3) : Bool)) : Bool)
                              then (currentlyEnabled Ext_Zihpm)
                              else
                                (do
                                  if ((((Sail.BitVec.extractLsb v__3852 11 5) == (0b1011000#7 : (BitVec 7))) && (let index : (BitVec 5) :=
                                         (Sail.BitVec.extractLsb v__3852 4 0)
                                       ((BitVec.toNatInt index) ≥b 3) : Bool)) : Bool)
                                  then (currentlyEnabled Ext_Zihpm)
                                  else
                                    (do
                                      if ((((Sail.BitVec.extractLsb v__3852 11 5) == (0b1011100#7 : (BitVec 7))) && (let index : (BitVec 5) :=
                                             (Sail.BitVec.extractLsb v__3852 4 0)
                                           ((BitVec.toNatInt index) ≥b 3) : Bool)) : Bool)
                                      then
                                        ...
                                        (do
                                          if ((((Sail.BitVec.extractLsb v__3852 11 5) == (0b1100000#7 : (BitVec 7))) && (let index : (BitVec 5) :=
                                                 (Sail.BitVec.extractLsb v__3852 4 0)
                                               ((BitVec.toNatInt index) ≥b 3) : Bool)) : Bool)
                                          then
                                            (do
                                            ...
                                            (do
                                              if ((((Sail.BitVec.extractLsb v__3852 11 5) == (0b1100100#7 : (BitVec 7))) && (let index : (BitVec 5) :=
                                                     (Sail.BitVec.extractLsb v__3852 4 0)
                                                   ((BitVec.toNatInt index) ≥b 3) : Bool)) : Bool)
                                              then
                                                (do
                                                ...
                                                (do
                                                  if ((((Sail.BitVec.extractLsb v__3852 11 5) == (0b0111001#7 : (BitVec 7))) && (let index : (BitVec 5) :=
                                                         (Sail.BitVec.extractLsb v__3852 4 0)
                                                       ((BitVec.toNatInt index) ≥b 3) : Bool)) : Bool)
                                                  then
                                                    ...
                                                    (do
                                                      match (v__3852, g__165, g__166) with
                                                      | (0xDA0, g__167, g__168) =>
...
/-- Type quantifiers: k_ex1075589_ : Bool -/
